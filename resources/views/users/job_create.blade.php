        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box">
                    ...
                    <h2 class="box-title">求人案件新規登録フォーム</h2>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        {!! Form::open(['route' => 'job.post', 'class' => 'form-horizontal', 'files' => true]) !!}
                        <table class="table-form mb30">
                            <tbody>
                                ...
                                <tr class="form-group @if(!empty($errors->first('simple_salary'))) has-error @endif">
                                    <th><label for="simple_salary" class="control-label">給与簡易（改行不可）<span class="fs13 red"> (※)</span></label></th>
                                    <td>
                                        {!! Form::text('simple_salary', old('simple_salary'), ['class'=>'form-control form-md']) !!}
                        ...
                        <table class="table-form mb30">
                            <tbody>
                                ...
                                <tr class="form-group @if(!empty($errors->first('pref'))) has-error @endif">
                                    ...
                                    <td>
                                        {!! Form::text('pref', old('pref'), ['class'=>'form-control form-sm']) !!}
